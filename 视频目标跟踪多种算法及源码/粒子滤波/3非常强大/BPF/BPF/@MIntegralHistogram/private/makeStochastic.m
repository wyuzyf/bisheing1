function [T,Z] = makeStochastic(T)
% makeStochastic Ensure the argument is a stochastic matrix, i.e., the sum over the last dimension is 1.
% [T,Z] = makeStochastic(T)
%
...
%
% written by K.P. Murphy
% modified by Wei-Lwun Lu
% makeStochastic.m version 1.0
