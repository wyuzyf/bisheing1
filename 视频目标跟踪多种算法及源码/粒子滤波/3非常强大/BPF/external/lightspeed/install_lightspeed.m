% compiles mex files for lightspeed library.
...
if ispc
  if strcmp(mexcompiler,'cl')
    if atleast65
      % version >= 6.5
      lapacklib = fullfile(matlabroot,'extern\lib\win32\microsoft\msvc60\libmwlapack.lib');
    end
  else
...
if ispc
  ...
  mex digamma.c mexutil.obj util.obj
  mex gammaln.c mexutil.obj util.obj
  mex randbinom.c util.obj
  mex randgamma.c util.obj
  mex repmat.c mexutil.obj
  mex sample_hist.c util.obj
  mex trigamma.c mexutil.obj util.obj
  try
    % standalone programs
...
if atleast65
  ...
  mex digamma.c mexutil.o util.o -lm
  mex gammaln.c mexutil.o util.o -lm
  mex randbinom.c util.o -lm
  mex randgamma.c util.o -lm
  mex repmat.c mexutil.o
  mex sample_hist.c util.o -lm
  mex trigamma.c mexutil.o util.o -lm
  try
    % standalone programs
    if atleast65
